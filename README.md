# nvim-treesitter-queries-kusto

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-kusto/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-kusto/actions/workflows/validate.yml)

Neovim tree-sitter queries for **kusto**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-kusto",
...
- [ ] Changes are scoped to `kusto` — do not include files for other languages
